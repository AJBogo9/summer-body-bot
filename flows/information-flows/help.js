...
helpScene.enter(async (ctx) => {
  ...
  if (ctx.update.message.chat.type === 'private') {
    ...
    helpMessage += 'If there is something that you did not understand or something problematic comes up you can send me a message on Telegram @EppuRuotsalainen or @arttukaup\\.'
  } else {
